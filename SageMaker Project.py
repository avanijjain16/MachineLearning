...
words_sample = review_to_words(train_X[100])
print(words_sample)
...
def build_dict(data, vocab_size = 5000):
    ...
    sorted_words = list(sorted_dict.keys() )
...
# **Answer:** based on below code - top 5 words frquently appearing are
# movi
# film
# one
# like
...
# **Answer:**method preprocess_data perform that each review is applied to review_to_words method, all of its output is saved as file. this will help in avoiding to run this step again as data is stored in file as this step took more time to execute however rerunning it did not take much time. convert_and_pad method is used to pass uniformed number of words to neural network. As review is written by human being, its length can't be same.
...
# Answer:Accuracy score of the untuned XGBoost model is slightly better than this RNN model. (XGBoost-  0.86 / RNN- 0.85248 ). Tuning the hyperparameters of the XGBoost model would gain another 2% of accuracy approximately.
# 
...
# 
# My predicted sentiment was Positive
